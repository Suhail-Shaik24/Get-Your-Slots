  ...
  return (
    <div className='p-4 md:p-5 lg:p-12 lg:py-6 flex flex-col gap-3 '>
      ...
      <div className="testimonial-super-container overflow-x-auto flex gap-3 rounded-lg scrollbar-hide">
        <div
          className="testimonials-container font-bold h-64 lg:h-72 w-[88%] bg-[#a3663c] text-white text-xl flex p-3 lg:p-4 gap-3 rounded-lg absolute left-1/2 transform -translate-x-1/2 ">
          What People Say</div>
        <TestimonialsArray />
      </div>
    </div>
