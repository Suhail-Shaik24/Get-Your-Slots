        ...
        <div className="socials flex text-white flex-col gap-3 items-center justify-center ">
          ...
          <div className="flex gap-3 items-center justify-center">
            <a href="https://www.instagram.com/getyourslots/" target="_blank" rel="noopener noreferrer" className=" hover:underline">
              <img src={Instagram} alt="Instagram" className="w-5 lg:w-8 hover:animate-bounce" />
            </a>
            <div className='border border-[#a3663c] h-6 rounded-full' />
            <a href="https://x.com/iamssuhail" target="_blank" rel="noopener noreferrer" className=" hover:underline">
              <img src={X} alt="LinkedIn" className=" w-4 lg:w-7 aspect-square hover:animate-bounce invert" />
            </a>
          </div>
        </div>
      </footer>
