...
const TestimonialsArray = () => {
  ...
  const [testimonialsArray] = useState([
    ...
    { id: 7, author: "Shanmukh", content: "It is very beneficial to all the students to book the slots by self instead going for fraud agents. Thank's a lot." },
    { id: 8, author: "Armaan", content: "This is very useful for all of us who wait for hours to book their slots. Thank you." },
    { id: 9, author: "Atharva", content: "One of the genuine service provider for all the visa information." },
    { id: 10, author: "Nagaraju", content: "It is a great place for finding visa slots. It helped me a lot." },
    { id: 11, author: "Vivek", content: "So useful and since it was not delayed alerts. It was very much helpful and informative." },
    { id: 12, author: "Shanmukh", content: "It is very beneficial to all the students to book the slots by self instead going for fraud agents. Thank's a lot." },
  ])
  return (
    <>
      <div className="containers flex gap-4 py-[0.6rem] mt-11 z-10 touch-none overscroll-none animate-scroll rounded-lg">
